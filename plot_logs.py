...
ax1.plot(total_responses, mean_lscores, marker="o")
ax1.set_xlabel("Total Responses")
ax1.set_ylabel("Discovered lscore")
ax1.set_title("Discovered lscore over Total Responses")
ax1.grid(True)

ax2.plot(total_responses, itemisation_rates, marker="o")
ax2.set_xlabel("Total Responses")
ax2.set_ylabel("Itemised Pages")
ax2.set_title("Itemised Pages over Total Responses")
ax2.grid(True)

ax3.plot(total_responses, itemisation_rates, marker="o")
ax3.set_xlabel("Total Responses")
ax3.set_ylabel("Itemisation Rate")
ax3.set_title("Itemisation Rate over Total Responses")
ax3.grid(True)

ax4.plot(total_responses, unique_fld_rate, marker="o")
ax4.set_xlabel("Total Responses")
ax4.set_ylabel("Discovery Rate")
ax4.set_title("Discovery Rate over Total Responses")
ax4.grid(True)
