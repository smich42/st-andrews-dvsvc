...
\begin{document}
\urlstyle{tt}
\title{Automating Discovery of UK Domestic Abuse Support Services}


\author{\IEEEauthorblockN{Stavros Michalovits\IEEEauthorrefmark{1}, Annah McCurry\IEEEauthorrefmark{2}, Ruth Hoffmann\IEEEauthorrefmark{1},\\ Swithun Crowe\IEEEauthorrefmark{3}, Patrick McCann\IEEEauthorrefmark{3}, David I Donaldson \IEEEauthorrefmark{2}, Bobby May\IEEEauthorrefmark{2}}
\IEEEauthorblockA{\IEEEauthorrefmark{1}School of Computer Science, University of St Andrews, St Andrews, Scotland\\
Email: sm519@st-andrews.ac.uk, rh347@st-andrews.ac.uk} \IEEEauthorblockA{\IEEEauthorrefmark{2}School of Psychology \& Neuroscience, University of St Andrews, St Andrews, Scotland} 
\IEEEauthorblockA{\IEEEauthorrefmark{3}Research Computing, University of St Andrews, St Andrews, Scotland} }
...
\node (vocab) at (0,0) {Vocabulary \\ \& Features};
\node (model) at (0,-1.5) {Relevance Models};
\node (crawl) at (0,-3) {Web Crawler};
\node[color=blue] (verify) at (5.5,0) {Human Expert};
\node[color=gray] (db) at (5.5,-1.5) {\color{gray}{Database}};
\node[color=gray] (web) at (5.5,-3) {\color{gray}{Website}};
